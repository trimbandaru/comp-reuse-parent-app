sap.ui.define([
    ...
    return BaseController.extend("com.test.parentapp.controller.Worklist", {
        ...
        navigateToRemote: function () {
            this.getRouter().navTo("detail", {},
                {
                    vendorindetailTarget: {
                        route: "object",
                        parameters: {
                            objectId: encodeURIComponent('(1)')
                        }
                    }
                });
        },
        navigateToRemotefe: function () {
            // this.getRouter().navTo("detailfe", {},{
