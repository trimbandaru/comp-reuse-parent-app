		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "parentapp",
									"targetURL": "#comtestparentapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestparentapp-display": {
								"semanticObject": "comtestparentapp",
								"action": "display",
								"description": "parentapp",
								"title": "parentapp",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.parentapp",
									"url": sap.ui.require.toUrl("com/test/parentapp")
								}
							}
						}
					}
